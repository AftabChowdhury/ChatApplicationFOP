...
public class ChatServer extends UnicastRemoteObject implements ChatServerIF {
	...
	private void registerChatter(String[] details){		
		try{
			...
			nextClient.messageFromServer("[Server] : " + details[0] + " has joined the group.\n");
	...
	public void sendToAll(String newMessage){
		newMessage = ClientRMIGUI.rot13(newMessage);
		System.out.println("sendToAll function:" + newMessage);
		for(Chatter c : chatters){
			try {
	...
	public void sendPM(int[] privateGroup, String privateMessage) throws RemoteException{
		Chatter pc;
		privateMessage = ClientRMIGUI.rot13(privateMessage);
